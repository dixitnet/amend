...
//
// Une page publiée porte un nom de **trois mots** plutôt qu'une suite de
// caractères aléatoires : `ocean-garden-river` se dicte au téléphone, se
// recopie depuis une diapositive, se reconnaît dans une liste. Une adresse
// publique sert précisément à circuler hors de l'écran.
//
// **Pourquoi des mots anglais dans une application en français.** Une
// adresse n'est pas du contenu : elle est lue par quiconque reçoit le lien,
// c'est-à-dire par le public le plus large qu'il y ait — plus large que
// celui du document lui-même. Trois mots français demanderaient à un
// anglophone de recopier ce qu'il ne sait ni lire ni prononcer, et la
// propriété qu'on venait chercher disparaîtrait exactement pour lui.
// L'inverse est faux : `ocean`, `garden`, `river` se lisent des deux côtés.
// Le français a sa place dans ce qu'on écrit, pas dans ce qu'on tape.
// (Décision du 17/09 — et c'est la seule concession à l'anglais dans
// l'application, aucune traduction n'étant prévue par ailleurs.)
//
// **D'où vient cette liste.** La liste anglaise de BIP-39, faite pour être
// lue, dictée et retapée sans ambiguïté : pas d'homophones qui se
// confondent, et les quatre premières lettres de chaque mot sont uniques,
// si bien qu'une faute de frappe en fin de mot reste rattrapable. ASCII par
// construction, trois à huit lettres, domaine public (dépôt bitcoin/bips).
//
// **Ce qu'on en a retiré** : une vingtaine de mots écartés à la main parce
// qu'associés au hasard à deux autres ils donneraient une lecture
// désagréable sur la page publique de quelqu'un. Le coût en entropie est
// nul ; le coût de ne pas le faire se paierait une fois, publiquement.
//
// **La liste est gelée.** Les noms sont stockés, pas recalculés — mais
// ajouter des mots réduit la part de hasard des anciens noms, et en retirer
// laisse des adresses qu'on ne saurait plus produire. On n'y touche pas
// sans raison écrite.
//
// 2033 mots, donc 8.40 milliards de combinaisons de trois mots (2^32), pour
// des adresses d'environ dix-huit caractères. C'est l'ordre de grandeur de
// what3words. Moins qu'un identifiant aléatoire de seize caractères, et
// c'est assumé : la contrepartie est la limitation de débit sur les pages
// publiques (voir server/server.js), sans laquelle deviner une adresse ne
// coûterait rien à celui qui essaie.

export const MOTS_PUBLICATION = [
  'abandon', 'ability', 'able', 'about', 'above', 'absent', 'absorb', 'abstract',
  'absurd', 'access', 'accident', 'account', 'accuse', 'achieve', 'acid', 'acoustic',
  ...
  'amused', 'analyst', 'anchor', 'ancient', 'anger', 'angle', 'animal', 'ankle',
  ...
  'best', 'better', 'between', 'beyond', 'bicycle', 'bid', 'bike', 'bind',
  'biology', 'bird', 'birth', 'bitter', 'black', 'blade', 'blanket', 'blast',
  ...
  'fancy', 'fantasy', 'farm', 'fashion', 'fat', 'father', 'fatigue', 'fault',
  ...
  'grow', 'grunt', 'guard', 'guess', 'guide', 'guilt', 'guitar', 'gym',
  ...
  'mutual', 'myself', 'mystery', 'myth', 'name', 'napkin', 'narrow', 'nasty',
  ...
  'position', 'possible', 'post', 'potato', 'pottery', 'powder', 'power', 'practice',
  ...
  'shy', 'sibling', 'side', 'siege', 'sight', 'sign', 'silent', 'silk',
  ...
  'water', 'wave', 'way', 'wealth', 'wear', 'weasel', 'weather', 'web',
